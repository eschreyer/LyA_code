...
def tau_los(y_c, planet_velocity, pw_functions, planet_radius, hill_sphere_radius, wgrid, atomic_xsection = xs.LyA_xsection):
    ...
    #intersects with planet
        ...
        #remember everything is not at 10**4K, however the assumption is that once the gas goes optically thin it will heat up
        #even it has passed the sonic point at a lower temp
