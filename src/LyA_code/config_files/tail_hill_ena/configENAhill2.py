...
sampled_parameter_guess = np.array([6.3, 8.5, 7, 11.5, 27.7, (2.5/4)*np.pi, 1.53, 6.7, -0.6])
...
transit_rng = (0.7, 31.4)
tgrid = np.concatenate((np.linspace(0.5, 10, 26), np.linspace(25.2, 31.5, 18)))
