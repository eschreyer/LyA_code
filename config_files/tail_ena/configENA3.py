...
SWTemp: 0.5 * 10^6K
Height Vary Fac: 0.3
Cut priors so that sound speed sonic point has to be greater than planet radius
...
sampled_parameter_guess = np.array([5.9, 9, 7, 12, 27.7, (2.5/4)*np.pi, 1.53, 6.7, -1])
