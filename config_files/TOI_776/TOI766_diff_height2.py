...
def make_rho_struc(parameters):
    ...
    c_s = np.sqrt(const.k_b * 10**4 / const.m_proton)   #parameters['c_s_planet']
...
sampled_parameter_guess = np.array([5.8, 8.8, 6.1, 8.8, 7, 11.5, 28.5, (3/5)*np.pi, (3/5)*np.pi, 1.565, 1.563])
